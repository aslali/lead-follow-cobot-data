...
meanprops = {"marker": "o",
             ...
             "markersize": "8"}
def decisions_reliability(df):
    decisions_reliability_by_task(df)
    decisions_reliability_by_difficulty(df)
    decisions_reliability_by_pattern(df)


def decisions_reliability_by_task(df):
    ...
    sns.boxplot(y='value', x='Task', data=n1n, showmeans=True, meanprops=meanprops)
...
def decisions_reliability_by_difficulty(df):
    var_name = 'Decisions Reliability'
    rtasks = []
    variable = []
...
def decisions_reliability_by_pattern(df):
    var_name = 'Decisions Reliability'
    pattern = []
    variable = []
    for i, row in df.iterrows():
